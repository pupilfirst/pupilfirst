...
let selected = () => {
  <div
    ...
    className="ltr:ml-2 rtl:mr-2 font-semibold text-sm p-4 md:px-3 md:py-2 cursor-pointer relative rounded-lg text-gray-900 hover:bg-gray-50 hover:text-primary-500"
    key="more-links">
    <span> {t("more")->str} </span> <i className="fas fa-caret-down ltr:ml-2 rtl:mr-2" />
  </div>
}
