...
describe WeeklyKarmaPoints::CreateService do
  ...
  before do
    travel_to(test_time) do
      ...
      create :karma_point, founder: l1_startup_1.founders.first, points: 100, created_at: 6.days.ago
      create :karma_point, founder: l1_startup_2.founders.first, points: 50, created_at: 6.days.ago
      create :karma_point, founder: l1_startup_2.founders.first, points: 25, created_at: 5.days.ago
      create :karma_point, founder: l2_startup_1.founders.first, points: 80, created_at: 6.days.ago
      create :karma_point, founder: l2_startup_2.founders.first, points: 50, created_at: 6.days.ago
      create :karma_point, founder: l2_startup_2.founders.first, points: 40, created_at: 5.days.ago

      # Create karma points for two weeks ago.
      create :karma_point, founder: l1_startup_1.founders.first, points: 70, created_at: 13.days.ago
      create :karma_point, founder: l1_startup_2.founders.first, points: 40, created_at: 13.days.ago
      create :karma_point, founder: l1_startup_2.founders.first, points: 35, created_at: 12.days.ago
      create :karma_point, founder: l2_startup_1.founders.first, points: 50, created_at: 12.days.ago
      create :karma_point, founder: l2_startup_1.founders.first, points: 50, created_at: 11.days.ago
      create :karma_point, founder: l2_startup_2.founders.first, points: 60, created_at: 10.days.ago
    end
  end
