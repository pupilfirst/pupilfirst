...
let make = (~courseId) => {
  <div className="max-w-4xl 2xl:max-w-5xl mx-auto px-5 mt-8">
    ...
    <div className="flex border border-gray-200 rounded-lg text-sm mt-6 overflow-hidden">
      <div className="p-6 bg-gray-100 border-r border-gray-200 max-w-xs">
        ...
        <div className="mt-4 flex items-center justify-between gap-2 p-1">
          ...
          <Link
            ...
            href={`/school/courses/${courseId}/calendars/new`}>
      ...
      <div className="p-6 bg-white flex-1">
        ...
        <button
          ...
          <PfIcon className="if i-plus-circle-regular if-fw" /> {"Add an event"->str}
        </button>
