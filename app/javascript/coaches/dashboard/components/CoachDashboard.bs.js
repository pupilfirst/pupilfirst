  ...
  return /* record */[
          ...
          /* render */(function (param) {
              ...
              var selectStartupCB = function (id) {
                return Curry._1(send, /* SelectStartup */Block.__(0, [id]));
              };
          ...
          /* reducer */(function (action, state) {
              if (typeof action === "number") {
                ...
                var newTE = action[0];
                return /* Update */Block.__(0, [/* record */[
                            /* selectedStartupId */state[/* selectedStartupId */0],
                            /* timelineEvents */List.map((function (oldTE) {
                                    var match = TimelineEvent$ReactTemplate.id(oldTE) === TimelineEvent$ReactTemplate.id(newTE);
                                    if (match) {
                                      return newTE;
                                    } else {
                                      return oldTE;
