class V1::UsersController < V1::BaseController
  ...
  def accept_cofounder_invitation
    ...
    Delayed::Job.enqueue BatchPushNotifyJob.new(founder_ids, :accept_cofounder_invitation, message, email: current_user.email)
  ...
  def reject_cofounder_invitation
    ...
    Delayed::Job.enqueue BatchPushNotifyJob.new(founder_ids, :reject_cofounder_invitation, message, email: current_user.email)
