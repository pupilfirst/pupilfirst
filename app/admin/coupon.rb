ActiveAdmin.register Coupon do
  ...
  permit_params :code, :coupon_type, :discount_percentage, :expires_at, :redeem_limit,
    :instructions, :user_extension_days, :referrer_extension_days
  ...
  form do |f|
    ...
    f.inputs 'Coupon Details' do
      ...
      f.input :referrer_extension_days, hint: 'The extra subscription days the referrer is rewarded with'
