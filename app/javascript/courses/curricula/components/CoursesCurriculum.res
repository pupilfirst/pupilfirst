...
let rendertarget = (target, statusOfTargets, author, courseId) => {
  ...
  <div
    ...
    <Link
      ...
      className="p-6 flex flex-grow items-center justify-between hover:text-primary-500 cursor-pointer focus:outline-none focus:ring-2 focus:ring-inset focus:ring-focusColor-500 focus:text-primary-500 focus:bg-gray-100 focus:rounded-lg"
