...
let make =
  ...
  render: _self =>
    <div className="side-panel__container d-flex flex-column">
      <div
        className="side-panel__coach-profile d-lg-flex text-center text-lg-left align-items-center p-4">
        <div
          className="side-panel__coach-profile-dp mb-3 mb-lg-0 mx-lg-0 mx-auto">
