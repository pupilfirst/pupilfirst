...
describe Levels::CloneService do
  ...
  let(:student_l1) { create :founder, cohort: cohort }
  let(:student_l2) { create :founder, cohort: cohort }
  ...
  describe "#clone" do
    it "creates a clone of the level into another course" do
      ...
      original_quiz_questions =
        level_one
          .targets
          .flat_map { |t| t.quiz&.quiz_questions }
          .compact
      ...
      original_answer_options =
        level_one
          .targets
          .flat_map { |t| t.quiz&.answer_options }
          .compact
          .pluck(:value, :hint)
