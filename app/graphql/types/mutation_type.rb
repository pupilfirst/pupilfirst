module Types
  class MutationType < Types::BaseObject
    field :update_school_link,
          mutation: Mutations::UpdateSchoolLink,
          null: false
    ...
    field :create_school_link,
          mutation: Mutations::CreateSchoolLink,
          null: false
    ...
    field :archive_coach_note,
          mutation: Mutations::ArchiveCoachNote,
          null: false
    ...
    field :create_vimeo_video,
          mutation: Mutations::CreateVimeoVideo,
          null: false
    ...
    field :update_certificate,
          ...
          null: false
    field :delete_certificate,
          mutation: Mutations::DeleteCertificate,
          null: false
    field :resolve_embed_code,
          mutation: Mutations::ResolveEmbedCode,
          null: false
    ...
    field :re_run_github_action, mutation: Mutations::ReRunGithubAction, null: false
  end
end
