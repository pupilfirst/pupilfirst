  ...
  <div
    ...
    <div
      ...
      {targetGroups |> Js.Array.length > 1
        ? <div
            className="target-group__group-reorder flex flex-col shadow ltr:rounded-l-lg rtl:rounded-r-lg absolute h-full border border-e-0 overflow-hidden text-gray-600 justify-between items-center bg-white">
            <button
              title={t("move_up")}
              ariaLabel={t("move_up")}
