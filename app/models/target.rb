...
class Target < ApplicationRecord
  ...
  KEY_RESUME_SUBMISSION = 'resume_submission'

  def self.valid_keys
    [KEY_SCREENING, KEY_COFOUNDER_ADDITION, KEY_R1_TASK, KEY_R1_SHOW_PREVIOUS_WORK, KEY_R2_TASK, KEY_ATTEND_INTERVIEW, KEY_FEE_PAYMENT, KEY_RESUME_SUBMISSION].freeze
  end
