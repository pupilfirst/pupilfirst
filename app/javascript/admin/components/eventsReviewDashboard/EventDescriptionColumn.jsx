...
export default class EventDescriptionColumn extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div>
        ...
        {!this.state.showDescriptionEdit && (
          <div style={{ width: "260px" }}>
            <div className="review-dashboard__event-description">
              {this.state.description}
            </div>
            <a className="cursor-pointer" onClick={this.toggleDescriptionForm}>
              Edit Description
            </a>
          </div>
        )}
        {this.state.showDescriptionEdit && (
          <div>
            ...
            <br />
            <br />
            <a className="button cursor-pointer" onClick={this.saveDescription}>
              Save
            </a>
          </div>
        )}
...
EventDescriptionColumn.propTypes = {
