module Oembed
  class Resolver
    ...
    def provider
      ...
      klass =
        providers.find do |provider_klass|
      ...
      fallback_klass =
        fallback_providers.find do |fallback_provider_klass|
      ...
      raise ProviderNotSupported,
            "The hostname '#{uri.host}' could not be resolved to any known provider."
    end
    ...
    def fallback_providers
      [
        ...
        Oembed::ScribehowFallbackProvider
      ]
    end
  end
end
