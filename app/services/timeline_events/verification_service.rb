  ...
  class VerificationService
    ...
    def mark_verified
      TimelineEvent.transaction do
        ...
        update_admission_stage if @target.present? && @target.key.in?([Target::KEY_ADMISSIONS_CODING_TASK, Target::KEY_ADMISSIONS_VIDEO_TASK, Target::KEY_ADMISSIONS_ATTEND_INTERVIEW])
      end
    end
