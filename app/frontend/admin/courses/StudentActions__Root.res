              ...
              <div className="flex justify-between mt-2 items-end">
                <div className="flex flex-col">
                  <div>
                    ...
                    <span className="text-xs ltr:ml-2 rtl:mr-2">
                  ...
                  <div>
                    ...
                    <span className="text-xs ltr:ml-2 rtl:mr-2"> {IssuedCertificate.issuedBy(ic)->str} </span>
                  </div>
                </div>
  ...
  let make = (~studentData, ~studentId, ~certificates) => {
    ...
    <div className="pt-5 pb-10">
                ...
                <div className="flex flex-col mt-2">
                  ...
                  <div className="flex items-end mt-2">
                    ...
                    <button
                      ...
                      className="btn btn-success ltr:ml-2 rtl:mr-2 text-sm h-10">
                      <FaIcon classes={issueButtonIcons(state.issuing)} />
                      <span className="ltr:ml-2 rtl:mr-2"> {t("issue_certificate_button")->str} </span>
                    </button>
                  </div>
                </div>,
      ...
      <div className="p-4 bg-red-50 border-red-300 rounded mt-12">
        ...
        <HelpIcon className="ltr:ml-2 rtl:mr-2" link={t("dropout_student.help_url")}>
        ...
        <div className="mt-2">
          {Belt.Option.isNone(state.student.droppedOutAt)
            ? <button
                ...
                <span className="ltr:ml-2 rtl:mr-2"> {t("dropout_student.button")->str} </span>
              </button>
            : <button
                disabled=state.saving
                ...
                <FaIcon classes={submitButtonIcons(state.saving)} />
                <span className="ltr:ml-2 rtl:mr-2"> {t("re_activate_student.button")->str} </span>
              </button>}
        </div>
      </div>
    </div>
