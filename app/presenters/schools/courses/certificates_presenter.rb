  ...
  module Courses
    class CertificatesPresenter < ApplicationPresenter
      ...
      def certificates
        ...
        ActiveRecord::Precounter.new(active_certificate).precount(
          :issued_certificates
        )
        ...
        inactive_certificates =
          @course
            ...
            .limit(9)
        ActiveRecord::Precounter.new(inactive_certificates).precount(
          :issued_certificates
        )

        latest_certificates =
          active_certificate.to_a + inactive_certificates.to_a
        latest_certificates.map do |c|
          CertificatesPresenter.certificate_details(c)
        end
      end
