class SmsExpiredStartupsJob < ActiveJob::Base
  def perform
    ...
    Rails.llog.info event: :sms_approved_startups_without_agreement, incubation_location: 'kochi'
    ...
    Rails.llog.info event: :sms_approved_startups_without_agreement, incubation_location: 'visakhapatnam'
  end
end
