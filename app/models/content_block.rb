class ContentBlock < ApplicationRecord
  ...
  BLOCK_TYPE_COMMUNITY_WIDGET = -'community_widget'
  ...
  def self.valid_block_types
    [BLOCK_TYPE_MARKDOWN, BLOCK_TYPE_IMAGE, BLOCK_TYPE_EMBED, BLOCK_TYPE_FILE,
     BLOCK_TYPE_COACHING_SESSION, BLOCK_TYPE_PDF_DOCUMENT, BLOCK_TYPE_COMMUNITY_WIDGET]
  end
  ...
  def community_widget?
    BLOCK_TYPE_COMMUNITY_WIDGET == block_type
  end
end
