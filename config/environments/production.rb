Rails.application.configure do
  ...
  config.action_controller.asset_host = 'https://sv-assets.sv.co'
  # config.action_controller.asset_host = 'https://d1efte8jdj3b9e.cloudfront.net'
