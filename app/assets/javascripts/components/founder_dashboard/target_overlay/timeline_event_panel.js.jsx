class TargetOverlayTimelineEventPanel extends React.Component {
  ...
  slackButton() {
    if(this.props.feedback.facultySlackUsername) {
      return(
        <a className="btn btn-with-icon btn-sm btn-primary discuss-on-slack__button"
  ...
  render() {
    return(
      <div className="target-overlay-timeline-event-panel__container pb-3 mt-3">
        <h6 className="target-overlay-timeline-event-panel__title font-semibold pl-1">Latest Timeline Submission:</h6>
        <div className="target-overlay-timeline-event-panel__box">
          ...
          <div className="target-overlay-timeline-event-panel__feedback mt-3">
            ...
            <p className="px-3 pt-3" dangerouslySetInnerHTML={ {__html: this.props.feedback.feedback} }/>
            <div className="p-3">
              { this.slackButton() }
            </div>
          </div>
