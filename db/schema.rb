...
ActiveRecord::Schema.define(version: 2021_02_25_054439) do
  ...
  create_table 'answer_options', force: :cascade do |t|
    ...
    t.index ['quiz_question_id'],
            name: 'index_answer_options_on_quiz_question_id'
  end
  ...
  create_table 'applicants', force: :cascade do |t|
    ...
    t.index %w[email course_id],
            name: 'index_applicants_on_email_and_course_id',
            unique: true
    t.index ['login_token'],
            name: 'index_applicants_on_login_token',
            unique: true
  end
  ...
  create_table 'community_course_connections', force: :cascade do |t|
    ...
    t.index ['community_id'],
            name: 'index_community_course_connections_on_community_id'
    t.index %w[course_id community_id],
            name:
              'index_community_course_connection_on_course_id_and_community_id',
            unique: true
  end
  ...
  create_table 'connect_requests', id: :serial, force: :cascade do |t|
    ...
    t.index ['connect_slot_id'],
            name: 'index_connect_requests_on_connect_slot_id'
  ...
  create_table 'content_blocks', force: :cascade do |t|
    ...
    t.index ['target_version_id'],
            name: 'index_content_blocks_on_target_version_id'
  end
  ...
  create_table 'faculty_course_enrollments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[course_id faculty_id],
            name:
              'index_faculty_course_enrollments_on_course_id_and_faculty_id',
            unique: true
    t.index ['faculty_id'],
            name: 'index_faculty_course_enrollments_on_faculty_id'
  end
  ...
  create_table 'faculty_startup_enrollments', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index ['faculty_id'],
            name: 'index_faculty_startup_enrollments_on_faculty_id'
    t.index %w[startup_id faculty_id],
            name:
              'index_faculty_startup_enrollments_on_startup_id_and_faculty_id',
            unique: true
  end
  ...
  create_table 'issued_certificates', force: :cascade do |t|
    ...
    t.index ['certificate_id'],
            name: 'index_issued_certificates_on_certificate_id'
    ...
    t.index ['serial_number'],
            name: 'index_issued_certificates_on_serial_number',
            unique: true
  ...
  create_table 'leaderboard_entries', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[founder_id period_from period_to],
            name: 'index_leaderboard_entries_on_founder_id_and_period',
            unique: true
  ...
  create_table 'levels', id: :serial, force: :cascade do |t|
    ...
    t.index %w[number course_id],
            name: 'index_levels_on_number_and_course_id',
            unique: true
  end
  ...
  create_table 'post_likes', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[post_id user_id],
            name: 'index_post_likes_on_post_id_and_user_id',
            unique: true
  ...
  create_table 'posts', force: :cascade do |t|
    ...
    t.index %w[post_number topic_id],
            name: 'index_posts_on_post_number_and_topic_id',
            unique: true
  ...
  create_table 'quiz_questions', force: :cascade do |t|
    ...
    t.index ['correct_answer_id'],
            name: 'index_quiz_questions_on_correct_answer_id'
  ...
  create_table 'resource_versions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[versionable_type versionable_id],
            name:
              'index_resource_versions_on_versionable_type_and_versionable_id'
  end
  ...
  create_table 'school_admins', force: :cascade do |t|
    ...
    t.index %w[user_id school_id],
            name: 'index_school_admins_on_user_id_and_school_id',
            unique: true
  ...
  create_table 'school_links', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[school_id kind], name: 'index_school_links_on_school_id_and_kind'
  end
  ...
  create_table 'school_strings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[school_id key],
            name: 'index_school_strings_on_school_id_and_key',
            unique: true
  end
  ...
  create_table 'startup_feedback', id: :serial, force: :cascade do |t|
    ...
    t.index ['timeline_event_id'],
            name: 'index_startup_feedback_on_timeline_event_id'
  end
  ...
  create_table 'target_evaluation_criteria', force: :cascade do |t|
    ...
    t.index ['evaluation_criterion_id'],
            name: 'index_target_evaluation_criteria_on_evaluation_criterion_id'
  ...
  create_table 'target_prerequisites', id: :serial, force: :cascade do |t|
    ...
    t.index ['prerequisite_target_id'],
            name: 'index_target_prerequisites_on_prerequisite_target_id'
  ...
  create_table 'text_versions', force: :cascade do |t|
    ...
    t.index %w[versionable_type versionable_id],
            name: 'index_text_versions_on_versionable_type_and_versionable_id'
  end
  ...
  create_table 'timeline_event_files', id: :serial, force: :cascade do |t|
    ...
    t.string 'title'
    t.index ['timeline_event_id'],
            name: 'index_timeline_event_files_on_timeline_event_id'
  end
  ...
  create_table 'timeline_event_grades', force: :cascade do |t|
    ...
    t.integer 'grade'
    t.index ['evaluation_criterion_id'],
            name: 'index_timeline_event_grades_on_evaluation_criterion_id'
    t.index %w[timeline_event_id evaluation_criterion_id],
            name: 'by_timeline_event_criterion',
            unique: true
    t.index ['timeline_event_id'],
            name: 'index_timeline_event_grades_on_timeline_event_id'
  end
  ...
  create_table 'timeline_event_owners', force: :cascade do |t|
    ...
    t.index ['timeline_event_id'],
            name: 'index_timeline_event_owners_on_timeline_event_id'
  end
  ...
  create_table 'topic_categories', force: :cascade do |t|
    ...
    t.index %w[name community_id],
            name: 'index_topic_categories_on_name_and_community_id',
            unique: true
  end
  ...
  create_table 'topic_subscriptions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[topic_id user_id],
            name: 'index_topic_subscriptions_on_topic_id_and_user_id',
            unique: true
  ...
  create_table 'users', id: :serial, force: :cascade do |t|
    ...
    t.index ['api_token_digest'],
            name: 'index_users_on_api_token_digest',
            unique: true
    t.index ['delete_account_token'],
            name: 'index_users_on_delete_account_token',
            unique: true
    t.index %w[email school_id],
            name: 'index_users_on_email_and_school_id',
            unique: true
  ...
  create_table 'webhook_endpoints', force: :cascade do |t|
    ...
    t.index ['course_id'],
            name: 'index_webhook_endpoints_on_course_id',
            unique: true
  end
