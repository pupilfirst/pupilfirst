...
feature 'Founder Dashboard' do
  ...
  before do
    ...
    create(:timeline_event, startup: startup, target: completed_target_1, verified_status: TimelineEvent::VERIFIED_STATUS_VERIFIED)
    create(:timeline_event, startup: startup, target: completed_target_2, verified_status: TimelineEvent::VERIFIED_STATUS_VERIFIED)
    create(:timeline_event, startup: startup, target: completed_target_3, verified_status: TimelineEvent::VERIFIED_STATUS_VERIFIED)
