...
describe Vimeo::ApiService do
  ...
  describe '#add_allowed_domain_to_video' do
    ...
    around do |example|
      original_value = Rails.application.credentials.vimeo_access_token
      Rails.application.credentials.vimeo_access_token = vimeo_access_token
      example.run
      Rails.application.credentials.vimeo_access_token = original_value
    end
