class ApplicantScreeningQuestion extends React.Component {
  coderQuestion() {
    switch (this.props.questionNumber) {
      ...
      default:
        console.error(
          "Unexpected question number: " + this.props.questionNumber
        );
        return null;
    }
  }
  ...
  render() {
    return (
      <h3
        className="applicant-screening__question font-semibold"
        dangerouslySetInnerHTML={this.question()}
      />
    );
  }
}

ApplicantScreeningQuestion.propTypes = {
