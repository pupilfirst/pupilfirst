...
class Startup < ApplicationRecord
  ...
  def self.admission_stages
    [ADMISSION_STAGE_SIGNED_UP, ADMISSION_STAGE_SELF_EVALUATION_COMPLETED, ADMISSION_STAGE_TEAM_MEMBERS_ADDED, ADMISSION_STAGE_CODING_TASK_PASSED, ADMISSION_STAGE_INTERVIEW_PASSED, ADMISSION_STAGE_ADMITTED].freeze
  end
