  ...
  <div className="flex gap-4 items-center p-4 rounded-lg bg-white border border-gray-200 ">
    ...
    <div>
      ...
      <div className="flex gap-2 flex-wrap">
        {["Tag 1", "Tag 2"]->Js.Array2.map(tag => <p className="px-2 py-1 text-xs bg-gray-50 text-gray-500 rounded-2xl "> {tag -> str} </p>)->React.array}
      </div>
    </div>
  </div>
    ...
    <div>
      <div>
        <div className="max-w-4xl 2xl:max-w-5xl mx-auto px-4 mt-8">
          <div className="mt-2 text-right flex gap-2 justify-between">
           ...
           <Link
              className="btn btn-primary" href={`/school/courses/${courseId}/teams/new`}>
              <PfIcon className="if i-plus-circle-light if-fw" />
              <span className="inline-block pl-2"> {str("Create Team")} </span>
            </Link>
          </div>
          <div className="bg-gray-100 sticky top-0 my-6">
          ...
          <div className="p-6 bg-white rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="px-3 py-2 text-xs bg-green-50 text-green-500 rounded-2xl "> {"Cohort name" -> str} </p>
              </div>
              <Link href=`/school/courses/${courseId}/teams/1/details` className="block px-3 py-2 bg-grey-50 text-sm text-grey-600 border rounded border-gray-300 hover:bg-primary-100 hover:text-primary-500 hover:border-primary-500 focus:outline-none focus:bg-primary-100 focus:text-primary-500 focus:ring-2 focus:ring-focusColor-500">
                <span className="inline-block pr-2"><i className="fas fa-edit"></i></span>
                <span>{"Edit" -> str}</span>
              </Link>
            </div>
