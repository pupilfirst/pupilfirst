...
feature 'Organisation show' do
  ...
  context 'when the user is an organisation admin' do
    scenario 'user can see all the inactive cohorts' do
      ...
      click_link cohort_3.name
      expect(page).to have_current_path(organisation_cohort_path(organisation_1, cohort_3))
    ...
    scenario 'check the working of breadcrumb' do
      ...
      visit inactive_cohorts_organisation_course_path(organisation_1, course_1)
    ...
    scenario 'user can not see the inactive cohorts page of an org, where he is not an admin' do
      sign_in_user(org_admin_user, referrer: inactive_cohorts_organisation_course_path(organisation_2, course_1))

      expect(page).to have_http_status(:not_found)
    end

    scenario 'user can visit active cohorts page from inactive cohorts page' do
      sign_in_user(org_admin_user, referrer: inactive_cohorts_organisation_course_path(organisation_1, course_1))
  ...
  context 'when the user is an school admin' do
    ...
    scenario 'user can see the inactive cohorts page of all organisations' do
      sign_in_user(school_admin_user, referrer: inactive_cohorts_organisation_course_path(organisation_2, course_1))
  ...
  context 'when the user is a non-admin' do
    scenario 'user can not see the inactive cohorts page' do
      sign_in_user(regular_user, referrer: inactive_cohorts_organisation_course_path(organisation_1, course_1))
