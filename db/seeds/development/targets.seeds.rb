...
after 'development:target_groups' do
  ...
  week_1_group_1 = week_1.target_groups.find_by(sort_index: 1)
  week_1_group_2 = week_1.target_groups.find_by(sort_index: 2)
  week_1_group_3 = week_1.target_groups.find_by(sort_index: 3)
  week_2 = batch.program_weeks.find_by(number: 2)
  week_2_group_1 = week_2.target_groups.find_by(sort_index: 1)
  week_2_group_2 = week_2.target_groups.find_by(sort_index: 2)
