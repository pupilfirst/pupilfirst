ActiveAdmin.register Event do
  ...
  form :partial => "form"
  permit_params :title, :description, :featured, :approved, :start_at_date, :start_at_time_hour, :start_at_time_minute, :end_at_date, :end_at_time_hour, :end_at_time_minute, :location, :category_id, :picture, :user_id, :time_zone, :posters_name, :posters_email, :posters_phone_number
