json.(startup, :id, :logo_url, :pitch, :website, :about, :email, :phone, :twitter_link, :facebook_link, :approval_status, :product_name, :product_description, :registration_type)
