...
let dropdownSelected =
  <button
    ...
    <i className="fas fa-chevron-down text-xs ltr:ml-3 rtl:mr-3 font-semibold" />
  </button>
      ...
      <div className="flex shadow bg-white rounded-lg flex-col justify-between h-full">
        <div>
          <div className="relative">
            ...
            <div
              ...
              <h4
                className="course-editor-course__title text-white font-semibold leading-tight ltr:pr-4 rtl:pl-4 text-lg md:text-xl">
          ...
          {ReactUtils.nullIf(
            <div className="px-4 pt-4">
              <a
                ...
                <Icon className="if i-external-link-solid ltr:mr-2 rtl:ml-2" />
        ...
        <div className="grid grid-cols-3 divide-x py-4 divide-gray-300 ">
          ...
          <Spread props={"data-t": `${Course.name(course)} levels count`}>
            <div className="flex-1 px-4">
              <p className="ltr:pr-6 rtl:pl-6 text-sm text-gray-500 font-medium"> {ts("levels")->str} </p>
              <p className="mt-1 text-lg font-semibold">
        ...
        <div className="grid grid-cols-6 gap-4 p-4">
          <a
            ...
            <div>
              <FaIcon classes="far fa-edit ltr:mr-3 rtl:ml-3" />
          ...
          <div
            ...
            <EmptyState
              ...
              primaryAction={<button
                ...
                <span className="font-semibold ltr:ml-1 rtl:mr-1"> {str(t("add_new_course"))} </span>
              </button>}
            ...
            <div className="flex items-center max-w-4xl 2xl:max-w-5xl mx-auto justify-between">
              ...
              | Loaded(stats) =>
                <div className="flex gap-6">
                  <div className="ltr:border-r rtl:border-l ltr:pr-6 rtl:pl-6">
