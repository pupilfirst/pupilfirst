ActiveAdmin.register Startup do
    ...
    case params[:email_to_send].to_sym
      when :approval
        ...
        startup.founders.each do |user|
          Delayed::Job.enqueue UserPushNotifyJob.new(user.id, :startup_approval, push_message)
  ...
  member_action :send_startup_profile_reminder, method: :post do
    ...
    startup.founders.each do |user|
      Delayed::Job.enqueue UserPushNotifyJob.new(user.id, :startup_profile_reminder, push_message)
    end
