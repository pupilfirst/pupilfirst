class ApplicantScreeningAnswerHint extends React.Component {
  coderHint() {
    switch (this.props.questionNumber) {
      ...
      default:
        console.error("Unexpected question number for hint: " + this.props.questionNumber);
        return null;
    }
  }
  ...
  render() {
    return (
      <p className="applicant-screening__answer-hint-text m-b-1" dangerouslySetInnerHTML={ this.hint() }>
      </p>
    );
  }
}
