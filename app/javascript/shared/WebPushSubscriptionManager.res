...
let button = (saving, onClick, icon, text) =>
  <button
    onClick
    disabled=saving
    className="inline-flex items-center font-semibold px-2 py-1 md:py-1 bg-gray-200 hover:bg-gray-300 focus:bg-gray-300 border rounded text-xs flex-shrink-0">
