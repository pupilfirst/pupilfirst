...
timeline_event_types = [
  ...
  ['moved_to_idea_discovery', 'Product', 'Moved to Idea Discovery Stage', 'We have started brainstorming to narrow on the next big idea to work on.', 'Not Needed', nil, 'moved_to_idea_discovery'],
  ['moved_to_prototyping', 'Product', 'Moved to Prototyping Stage', 'We have started work towards buidlding the first prototype of our [Product/Platform].', 'Link to prototype drafts or demos', 'moved_to_idea_discovery,moved_to_customer_validation', 'moved_to_prototyping'],
  ['moved_to_customer_validation', 'Product', 'Moved to Customer Validation Stage', "We've [moved/moved back] to the Customer Validation stage. [..]", 'If you have moved back, an End Iteration entry. If you have moved on from the Prototyping stage, an accepted "Finished Prototype Demo"', 'moved_to_prototyping', nil],
  ...
  ['team_formed','Product','Team Formed','We are a bunch of [Technology/Music/...] enthusiasts from [College/City] and we are excited to start! Our team has Name (Role), Name 2 (Role 2), ...','Not Needed',nil,'team_formation'],
  ...
  ['one_liner','Product','Set New One-Liner','We have set a new one-line mission for our product! We want to [organize the worlds information/...]. We think this mission is great because [...].','Not Needed','moved_to_idea_discovery,moved_to_customer_validation','mission'],
  ['joined_svco', 'Product', 'Joined SV.CO', 'We just registered our startup on SV.CO. Looking forward to an amazing learning experience', 'Proof: Not Needed', nil, 'team_formation']
]
