...
let showCheckListEdit = (checklist, setState) => {
  checklist
  |> Array.mapi((i, reviewChecklistItem) =>
       <div className="mt-2" key={i |> string_of_int}>
         <div className="mt-5">
                     ...
                     <div
                       ...
                       <div className="">
                         <input
                           ...
                           type_="text"
                           placeholder="Add title for checklist item"
                           value={checklistItem |> ReviewChecklistResult.title}
                           onChange={event =>
                             updateChecklist(
                               reviewChecklistItem
    ...
    <div className="bg-gray-300 rounded-lg mt-2">
      <div className="flex justify-end px-4">
        <button
          ...
          {(state.editMode ? "Close" : "Edit Checklist") |> str}
        </button>
      </div>
      <div className="px-4">
        {state.editMode
           ? showCheckListEdit(state.reviewChecklist, setState)
           : showCheckList(state.reviewChecklist)}
      </div>
    </div>
