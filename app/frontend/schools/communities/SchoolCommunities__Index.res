          ...
          <div
            ...
            <div className="course-faculty__list-item flex w-full items-center">
              <button
                ...
                className="course-faculty__list-item-details flex flex-1 items-center justify-between border border-transparent cursor-pointer rounded-l-lg ltr:text-left rtl:text-right hover:bg-gray-50 hover:text-primary-500 hover:border-primary-400 focus:bg-gray-50 focus:text-primary-500">
