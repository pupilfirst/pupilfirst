...
Devise.setup do |config|
  ...
  config.omniauth :keycloak_openid, ENV['KEYCLOAK_CLIENT_ID'], ENV['KEYCLOAK_CLIENT_SECRET'], client_options: { site: ENV['KEYCLOAK_SITE'], realm: ENV['KEYCLOAK_REALM'] }, :strategy_class => OmniAuth::Strategies::KeycloakOpenId
