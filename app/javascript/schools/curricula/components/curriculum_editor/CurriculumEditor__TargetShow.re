...
let archivedClasses = archived =>
  archived ?
    "target-group__target hover:bg-grey-200 target-group__target--archived border border-b-0 px-5 py-4" :
    "target-group__target hover:bg-grey-200 bg-white border border-b-0 px-5 py-6";
