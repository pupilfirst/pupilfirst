      ...
      <div className="pt-6">
        <div className="flex">
          <label className="block text-sm font-medium" htmlFor="cohortEndsAt">
            ...
            <span className="text-xs ltr:ml-1 rtl:mr-1 font-light"> {ts("optional_braces")->str} </span>
          </label>
          <HelpIcon className="ltr:ml-1 rtl:mr-1 text-sm"> {t("cohort_ends_at.help")->str} </HelpIcon>
        </div>
        <div className="mt-1">
          <DatePicker
