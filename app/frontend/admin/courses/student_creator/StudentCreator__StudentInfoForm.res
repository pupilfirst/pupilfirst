  ...
  <div>
    ...
    <div className="pt-6">
      <label className="block text-sm font-medium" htmlFor="title">
        {t("title.label")->str}
        <span className="inline-block text-xs ltr:ml-1 rtl:mr-1"> {ts("optional_braces")->str} </span>
      </label>
      <input
        value=state.title
    ...
    <div className="pt-6">
      <label className="block text-sm font-medium" htmlFor="affiliation">
        ...
        <span className="text-xs ltr:ml-1 rtl:mr-1"> {ts("optional_braces")->str} </span>
      </label>
      <input
    ...
    <div className="pt-6">
      <div className="flex items-center ltr:space-x-2">
        <label className="block text-sm font-medium" htmlFor="team_name">
          {t("team.label")->str}
          <span className="text-xs ltr:ml-1 rtl:mr-2"> {ts("optional_braces")->str} </span>
        </label>
        <HelpIcon className="ltr:ml-1 rtl:mr-1"> {t("team.help")->str} </HelpIcon>
      </div>
      <input
    ...
    <div className="pt-6">
      <label className="block text-sm font-medium" htmlFor="tags">
        {t("tags.label")->str} <span className="text-xs ltr:ml-1 rtl:mr-1"> {ts("optional_braces")->str} </span>
      </label>
    </div>
    ...
    <button
      ...
      <i className="fas fa-plus ltr:mr-2 rtl:ml-2" /> {t("add_to_list")->str}
    </button>
  </div>
}
