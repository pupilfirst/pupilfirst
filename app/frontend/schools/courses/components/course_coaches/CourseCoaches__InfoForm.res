    ...
    <div className="py-6 border-b border-gray-300 bg-gray-50">
      <div className="max-w-2xl mx-auto">
        <div className="flex">
          ...
          | Some(avatarUrl) => <img className="w-12 h-12 rounded-full ltr:mr-4 rtl:ml-4" src=avatarUrl />
          | None => <Avatar name={coach |> CourseCoach.name} className="w-12 h-12 ltr:mr-4 rtl:ml-4" />
          }}
    ...
    <div className="max-w-2xl mx-auto pb-5">
      {state.loading
        ? <div className="py-3 flex">
            {SkeletonLoading.card(~className="w-full ltr:mr-2 rtl:ml-2", ())}
            {SkeletonLoading.card(~className="w-full ltr:ml-2 rtl:mr-2", ())}
          </div>
        : <div className="py-3 flex mt-4">
            <div
              className="w-full ltr:mr-2 rtl:ml-2 rounded-lg shadow px-5 py-6"
      ...
      <span className="inline-block ltr:mr-1 rtl:ml-1 my-2 text-sm font-semibold pt-5">
