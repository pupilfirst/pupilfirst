    ...
    <div className="flex justify-between">
      <div className="flex">
        ...
        | Some(user) =>
          ...
          | Some(avatarUrl) =>
            <img
              className="w-8 h-8 md:w-10 md:h-10 text-xs border border-gray-300 rounded-full overflow-hidden shrink-0 mt-1 md:mt-0 me-2 me-3 object-cover"
              src=avatarUrl
            />
          | None =>
            <Avatar
        ...
        | None =>
          <Avatar
            name="?"
            className="w-8 h-8 md:w-10 md:h-10 text-xs border rounded-full overflow-hidden shrink-0 mt-1 md:mt-0 me-2 me-3 object-cover"
          />
        }}
        <div>
