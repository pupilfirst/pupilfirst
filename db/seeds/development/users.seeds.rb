...
after 'development:schools' do
  ...
  School.all.each do |school|
    school.users.where(email: 'admin@example.com').first_or_create!(name: Faker::Name.name)
  end
  ...
  (1..3).each do |index|
    school.users.create!(email: "student#{index}@example.com", name: Faker::Name.name)
  end
