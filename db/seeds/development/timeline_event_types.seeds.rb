...
timeline_event_types = [
  ...
  ['joined_svco', 'Governance', 'Joined SV.CO', 'We just registered our startup on SV.CO. Looking forward to an amazing learning experience', 'Proof: Not Needed', nil, 'team_formation']
]
