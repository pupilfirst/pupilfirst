...
let issuedToName = issuedCertificate => {
  ...
  if issuedTo == profileName {
    ...
    profileName ++ "<i className=\"ltr:ml-1 rtl:mr-1 fas fa-exclamation-circle\" /></a>"
  }
}
  ...
  | Screen =>
    <div className="container mx-auto px-3 max-w-5xl py-8">
      <div
        ...
        <div className="text-center md:w-5/12 pr-0 ltr:md:pr-5 rtl:md:pl-5">
      ...
      {ReactUtils.nullIf(
        <div
          ...
          <div
            className="ltr:ml-4 rtl:mr-4 text-sm"
            dangerouslySetInnerHTML={DOMPurify.sanitizedHTMLOpt(
              t(
  ...
  | Print =>
    <div className="flex flex-col items-center">
      <button
        ...
        <i className="fas fa-undo-alt" /> <span className="ltr:ml-1 rtl:mr-1"> {t("cancel")->str} </span>
      </button>
      <IssuedCertificate__Root issuedCertificate verifyImageUrl />
    </div>
  }
