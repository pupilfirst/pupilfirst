  ...
  Level.all.each do |level|
    ...
    level.target_groups.each do |target_group|
      ...
      2.times do
        ...
        target_group.targets.create!(days_to_complete: [7, 10, 14].sample, title: Faker::Lorem.sentence, role: Target.valid_roles.sample, target_group: target_group, description: paragraph, faculty: faculty, target_action_type: Target::TYPE_TODO, resubmittable: true, visibility: 'archived', safe_to_change_visibility: true)
        target_group.targets.create!(days_to_complete: [7, 10, 14].sample, title: Faker::Lorem.sentence, role: Target.valid_roles.sample, target_group: target_group, description: paragraph, faculty: faculty, target_action_type: Target::TYPE_TODO, resubmittable: true, visibility: 'draft', safe_to_change_visibility: true)
      end
