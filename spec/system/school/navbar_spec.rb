...
feature 'School Admin Navbar', js: true do
  ...
  let!(:course_ended) { create :course, school: school_1, ends_at: 1.day.ago }
  let!(:course_archived) { create :course, school: school_1, ends_at: 1.day.ago, archived_at: 1.day.ago }
  ...
  scenario 'school admin visits the admin interface' do
    ...
    expect(page).not_to have_link(course_ended.name, href: "/school/courses/#{course_ended.id}/students")
    expect(page).not_to have_link(course_archived.name, href: "/school/courses/#{course_archived.id}/students")
    ...
    expect(page).not_to have_link(course_ended.name, href: "/school/courses/#{course_2.id}/curriculum")
    expect(page).not_to have_link(course_archived.name, href: "/school/courses/#{course_2.id}/curriculum")
  ...
  scenario 'school admin visits an ended course' do
    ...
    expect(page).to have_link(course_1.name, href: "/school/courses/#{course_1.id}/curriculum")
  end
end
