class HomeController < ApplicationController
  ...
  def leaderboards
    ...
    @leaderboard = {
      ...
      l2015_08_31: [
        { rank: '1', startup_name: 'Grey Codes', startup_timeline: '', team_lead: 'Ajmal Azeez' },
        { rank: '2', startup_name: 'Tapiko', startup_timeline: '', team_lead: 'Anik Raj' },
        { rank: '3', startup_name: 'Openloop Labs', startup_timeline: '', team_lead: 'Francis Alexander' },
        { rank: '4', startup_name: 'Bash', startup_timeline: '', team_lead: 'Hanzal Salim' },
        { rank: '4', startup_name: 'Tega', startup_timeline: '', team_lead: 'ARAVIND MURALEEDHARAN' },
        { rank: '4', startup_name: 'CreditoFlux', startup_timeline: '', team_lead: 'Sachu S' },
        { rank: '7', startup_name: 'Zorg', startup_timeline: '', team_lead: 'Varghese George' },
        { rank: '7', startup_name: 'Inocular', startup_timeline: '', team_lead: 'Aravind Sai.V' },
        { rank: '9', startup_name: 'F5 Inc', startup_timeline: '', team_lead: 'Mohammed Akhil P R' },
        { rank: '10', startup_name: 'Investo', startup_timeline: '', team_lead: 'Tashrif Yusuf' },
        { rank: '11', startup_name: 'HandMe', startup_timeline: '', team_lead: 'Arun P' },
        { rank: '12', startup_name: '10s', startup_timeline: '', team_lead: 'Arya Murali' },
        { rank: '13', startup_name: 'Codesap Tech LLP', startup_timeline: '', team_lead: 'Alen Thomas' },
        { rank: '13', startup_name: 'Creazone', startup_timeline: '', team_lead: 'FELIX JOSEMON' },
        { rank: '15', startup_name: 'Semantica', startup_timeline: '', team_lead: 'Stenal P Jolly' },
        { rank: '16', startup_name: 'Thirsty Crow', startup_timeline: '', team_lead: 'Anand B' },
        { rank: '16', startup_name: 'Renaissance', startup_timeline: '', team_lead: 'NAKENDRA KUMAR S' },
        { rank: '16', startup_name: '(College) School Of Engineering, CUSAT', startup_timeline: '', team_lead: 'Athul B Raj' },
        { rank: '19', startup_name: 'StartRaise', startup_timeline: '', team_lead: 'Sherin Antony' },
