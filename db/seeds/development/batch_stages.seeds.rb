...
after 'development:application_stages', 'development:batches' do
  ...
  # Batch in interview stage.
  batch_applications = Batch.find_by batch_number: 5
  ...
  # Batch in interview stage.
  batch_interview = Batch.find_by batch_number: 4
  ...
  # Batch in pre-selection
  batch_pre_selection = Batch.find_by batch_number: 3
