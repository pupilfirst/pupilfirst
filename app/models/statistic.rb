class Statistic < ActiveRecord::Base
  ...
  PARAMETER_COUNT_USERS_STUDENTS = 'count_users_students'
  ...
  def self.valid_parameters
    [PARAMETER_COUNT_USERS, PARAMETER_COUNT_USERS_STUDENTS, PARAMETER_COUNT_STARTUPS, PARAMETER_COUNT_STARTUPS_UNREADY, PARAMETER_COUNT_STARTUPS_PENDING, PARAMETER_COUNT_STARTUPS_APPROVED, PARAMETER_COUNT_STARTUPS_REJECTED, PARAMETER_COUNT_STARTUPS_AGREEMENT_SIGNED, PARAMETER_COUNT_STARTUPS_LIVE_AGREEMENT]
  end
