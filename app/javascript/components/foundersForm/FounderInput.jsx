...
export default class FounderInput extends React.Component {
  constructor(props) {
    super(props);
  ...
  inputId() {
    return (
      "founders-form__founder-" + this.props.name + "-input-" + this.props.index
    );
  }
  ...
  emailHint() {
    return (
      <span className="help-block">
        ...
        <a
          id="founder-form__password-hint-accept"
          onClick={this.acceptEmailHint}
          className="btn btn-sm btn-success application-form__email-hint-button m-r-1"
        >
          Yes
        </a>
        <a
          id="founder-form__password-hint-reject"
          onClick={this.rejectEmailHint}
          className="btn btn-sm btn-danger application-form__email-hint-button"
        >
          No
        </a>
      </span>
