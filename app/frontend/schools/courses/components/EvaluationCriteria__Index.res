    ...
    <div className="course-faculty__list-item flex w-full items-center">
      <button
        ...
        <div className="flex w-full text-sm justify-between">
          ...
          <span className="ltr:ml-2 rtl:mr-2 py-5 px-5 font-medium text-gray-600 hover:text-primary-500">
  ...
  <div className="bg-gray-50 h-full">
    ...
    <div className="flex px-6 py-2 items-center justify-between">
      <button
        ...
        <h5 className="font-semibold ltr:ml-2 rtl:mr-2"> {t("add_new_criterion") |> str} </h5>
      </button>
    </div>
