class FounderDashboardLevelUpNotification extends React.Component {
  ...
  eligibleNotificationText() {
    if (this.props.currentLevel === 0) {
      ...
      return(
        <div><h4 className="font-regular light-grey-text">You've completed our Level Framework, but you know by now that this is just the beginning of your startup journey.</h4><p> Thanks for sharing your life experiences with SV.CO. Hope this has been an awesome experience. For graduation options & access to the Alumni network, write to <a href='mailto:graduation@sv.co'>graduation@sv.co</a></p></div>);
    } else {
